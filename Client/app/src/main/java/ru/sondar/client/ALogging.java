...
public class ALogging implements LoggerInterface {
	...
	public void Log(int loggingLevel,String logTag,String logMsg){
		switch(loggingLevel){
			case Log.DEBUG:Log.d(logTag, logMsg);break;
			case Log.INFO:Log.i(logTag, logMsg);break;
			case Log.WARN:Log.w(logTag, logMsg);Log.e("Warning",logMsg);break;
			case Log.ERROR:Log.e(logTag, logMsg);Log.e("Error",logMsg);break;
		}
	}
	/**
	...
	public void Log(int loggingLevel, String logTag, String logMsg, Throwable errorStackTrace){
		switch(loggingLevel){
			case Log.DEBUG:Log.d(logTag, logMsg,errorStackTrace);break;
			case Log.INFO:Log.i(logTag, logMsg,errorStackTrace);break;
			case Log.WARN:Log.w(logTag, logMsg,errorStackTrace);Log.e("Warning",logMsg,errorStackTrace);break;
			case Log.ERROR:Log.e(logTag, logMsg,errorStackTrace);Log.e("Error",logMsg,errorStackTrace);break;
		}
	}
	/**
