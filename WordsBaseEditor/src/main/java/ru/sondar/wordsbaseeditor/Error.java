...
public class Error extends javax.swing.JFrame {
    ...
    public Error(Exception error) {
        initComponents();
        jLabel1.setText(error.getClass().toString());
        jLabel2.setText(error.getMessage());
        String temp = "";
        for (int i = 0; i < error.getStackTrace().length; i++) {
            temp += error.getStackTrace()[i].toString() + "\n";
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Error(new NullPointerException("test")).setVisible(true);
        });
    }
